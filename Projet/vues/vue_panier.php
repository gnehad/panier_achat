    ...
    <div class="container site">
        ...
        <div class="row">
            <div id ="contenu">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="total card-text">Total avant taxes: <?=number_format($total, 2)?>$</h4>
                        <h4 class="taxe card-text">TPS = 5%</h4>
                        <h4 class="taxe card-text">TVQ = 9,975%</h4>
                        <?php
                            $total = $total * (1 + 0.05 + 0.09975);
                        ?>
                        <h4 class="total card-text" id="total" montant="<?=$total?>">Total à payer : <?=number_format($total, 2)?>$</h4>
                    </div>
                </div>
                <?php
                        }
